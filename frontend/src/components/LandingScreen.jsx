...
// SVG for the Calendar Icon (for event announcement)
const CalendarIcon = () => (
    ...
    <div className="relative min-h-screen w-full bg-gray-900 text-white font-sans overflow-hidden">
      ...
      <div className="relative z-10">
        <div className="container mx-auto p-6 pb-28">
          ...
          <main className="space-y-12"> {/* Increased space between sections */}

            {/* --- NEW: EVENT ANNOUNCEMENT ADDED HERE --- */}
            <motion.section 
                {...sectionVariant} 
                className="bg-gradient-to-r from-blue-600 to-purple-600 p-6 rounded-2xl shadow-lg text-center border border-blue-400 animate-pulse-once"
            >
                <div className="flex justify-center items-center mb-3">
                    <CalendarIcon />
                    <h2 className="text-2xl font-bold text-white">Instant Verification Event!</h2>
                </div>
                <p className="text-lg text-yellow-300 font-semibold">October 9th, 2025 | 10:00 AM - 2:00 PM</p>
                <p className="mt-2 text-blue-100 font-medium">Find our team member at **BCR** to get registered on the spot and start connecting instantly!</p>
                {/* Optional: Add a simple pulse animation for extra attention */}
                <style jsx>{`
            ...
            <motion.section {...sectionVariant} className="text-center">
                ...
                <div className="aspect-w-9 aspect-h-16 max-w-sm mx-auto bg-gray-800 rounded-2xl overflow-hidden shadow-2xl border-2 border-blue-500/50">
                    {/* Make sure your video file is named 'promo-video.mp4' and is inside the /public folder */}
                    <video 
                        src="/promo-video.mp4" 
                        className="w-full h-full"
                        autoPlay  // Video starts automatically
                        loop      // Video repeats after finishing
                        muted     // Video starts without sound (good for autoPlay)
                        playsInline // Important for iOS autoPlay
                        controls   // Optional: Add video controls for user (play/pause, volume)
                    >
